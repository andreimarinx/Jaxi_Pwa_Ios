...
let appTitle = "Jaxi"
let webAppUrl = URL(string: "https://www.jaxi.tk")
let allowedOrigin = "jaxi.tk"
...
let navigationBarColor = getColorFromHex(hex: 0xEF8354, alpha: 1.0)
let navigationTitleColor = getColorFromHex(hex: 0xFFFFFF, alpha: 1.0)
let navigationButtonColor = navigationTitleColor
let progressBarColor = getColorFromHex(hex: 0x3FA7D6, alpha: 1.0)
